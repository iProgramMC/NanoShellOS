...
int I_CDMusPlay(__attribute__((unused)) int track)
{
#ifdef ORIGCODE
    int result;
...
int I_CDMusSetVolume(__attribute__((unused)) int volume)
{
    /* Not supported yet */
...
int I_CDMusTrackLength(__attribute__((unused)) int track_num)
{
#ifdef ORIGCODE
    SDL_CDtrack *track;
