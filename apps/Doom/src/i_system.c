...
// Copyright(C) 2012 iProgramInCpp
...
#include <stdarg.h>
#include <nsstandard.h>//NanoShell
...
#endif
#endif*/
	return true;//yes it is a real console.
}
...
void I_Error (const char *error, ...)
{
	...
	LogMsgNoCr("DOOM ERROR!:");
	
	//vsprintf(argptr, error, argptr);
	va_end(argptr);
	
	//LogMsg("DOOM ERROR: %s", msgbuf);
...
*/
    ...
    //MessageBox(NULL, msgbuf, "Error", MB_OK | ICON_ERROR << 16);
