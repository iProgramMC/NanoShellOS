...
void I_InitGraphics (void)
{
    ...
    if (i > 0) {
        ...
        if (s_Fb.yres / SCREENHEIGHT < (unsigned)fb_scaling)
...
{
    int y, x_offset, __attribute__((unused)) y_offset, x_offset_end;
...
void I_SetGrabMouseCallback (__attribute__((unused)) grabmouse_callback_t func)
{
}
...
void I_DisplayFPSDots (__attribute__((unused)) boolean dots_on)
{
}
