...
int M_CheckParmWithArgs(__attribute__((unused)) char *check, __attribute__((unused)) int num_args)
{
    /*int i;
...
int M_CheckParm(__attribute__((unused)) char *check)
{
...
static void LoadResponseFile(__attribute__((unused)) int argv_index)
{
#if ORIGCODE
    FILE *handle;
    int size;
