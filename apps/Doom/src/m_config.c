...
static void SaveDefaultCollection(__attribute__((unused)) default_collection_t *collection)
{
#if ORIGCODE
    default_t *defaults;
    int i, v;
...
static void LoadDefaultCollection(__attribute__((unused)) default_collection_t *collection)
{
#if ORIGCODE
    FILE *f;
    default_t *def;
...
char *M_GetSaveGameDir(__attribute__((unused)) char *iwadname)
{
    char *savegamedir;
#if ORIGCODE
    char *topdir;
