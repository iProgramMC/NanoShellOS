...
static uint16_t cpu_memory_read_byte(nes_mem_td *memmap, uint16_t addr, UNUSED uint16_t data) 
{
    return (memmap->cpu_memory[addr]); 
}

static uint16_t cpu_memory_read_word(nes_mem_td *memmap, uint16_t addr, UNUSED uint16_t data) 
{
...
static uint16_t prg_memory_read_byte(nes_mem_td *memmap, uint16_t addr, UNUSED uint16_t data) 
{
    return (memmap->cpu_prg_memory[addr]); 
}

static uint16_t prg_memory_read_word(nes_mem_td *memmap, uint16_t addr, UNUSED uint16_t data) 
{
...
static uint16_t ppu_memory_read_byte(nes_mem_td *memmap, uint16_t addr, UNUSED uint16_t data) 
{
    return (memmap->ppu_memory[addr]); 
}

static uint16_t ppu_memory_read_word(nes_mem_td *memmap, uint16_t addr, UNUSED uint16_t data) 
{
