...
// NanoShell does in no way support dynamic libraries right now.
#if defined TCC_IS_NATIVE && defined NANOSHELL
#  undef TCC_IS_NATIVE
#endif
...
# define CONFIG_TCCDIR "/User/local/Library/tcc"
#endif
#ifndef CONFIG_LDDIR
# define CONFIG_LDDIR "Library"
#endif
...
# define CONFIG_TCC_CRTPREFIX USE_TRIPLET(CONFIG_SYSROOT "/User/" CONFIG_LDDIR)
#endif

#ifndef CONFIG_USR_INCLUDE
# define CONFIG_USR_INCLUDE "/User/Include"
#endif
...
#  define CONFIG_TCC_SYSINCLUDEPATHS \
        "{B}/Include" \
    ":" ALSO_TRIPLET(CONFIG_SYSROOT "/User/local/Include") \
...
# ifdef TCC_TARGET_PE
#  define CONFIG_TCC_LIBPATHS "{B}/Library"
# else
#  define CONFIG_TCC_LIBPATHS \
        "{B}" \
    ":" ALSO_TRIPLET(CONFIG_SYSROOT "/User/" CONFIG_LDDIR) \
    ":" ALSO_TRIPLET(CONFIG_SYSROOT "/" CONFIG_LDDIR) \
    ":" ALSO_TRIPLET(CONFIG_SYSROOT "/User/local/" CONFIG_LDDIR)
# endif
#endif
...
# if TARGETOS_FreeBSD
#  define CONFIG_TCC_ELFINTERP "/Libraryexec/ld-elf.so.1"
# elif TARGETOS_FreeBSD_kernel
#  if defined(TCC_TARGET_X86_64)
#   define CONFIG_TCC_ELFINTERP "/Library/ld-kfreebsd-x86-64.so.1"
#  else
#   define CONFIG_TCC_ELFINTERP "/Library/ld.so.1"
#  endif
# elif TARGETOS_DragonFly
#  define CONFIG_TCC_ELFINTERP "/User/Libraryexec/ld-elf.so.2"
# elif TARGETOS_NetBSD
#  define CONFIG_TCC_ELFINTERP "/User/Libraryexec/ld.elf_so"
# elif TARGETOS_OpenBSD
#  define CONFIG_TCC_ELFINTERP "/User/Libraryexec/ld.so"
# elif defined __GNU__
#  define CONFIG_TCC_ELFINTERP "/Library/ld.so"
# elif defined(TCC_TARGET_PE)
#  define CONFIG_TCC_ELFINTERP "-"
# elif defined(TCC_UCLIBC)
#  define CONFIG_TCC_ELFINTERP "/Library/ld-uClibc.so.0" /* is there a uClibc for x86_64 ? */
# elif defined TCC_TARGET_ARM64
#  if defined(TCC_MUSL)
#   define CONFIG_TCC_ELFINTERP "/Library/ld-musl-aarch64.so.1"
#  else
#   define CONFIG_TCC_ELFINTERP "/Library/ld-linux-aarch64.so.1"
#  endif
# elif defined(TCC_TARGET_X86_64)
#  if defined(TCC_MUSL)
#   define CONFIG_TCC_ELFINTERP "/Library/ld-musl-x86_64.so.1"
#  else
#   define CONFIG_TCC_ELFINTERP "/Library64/ld-linux-x86-64.so.2"
#  endif
# elif defined(TCC_TARGET_RISCV64)
#  define CONFIG_TCC_ELFINTERP "/Library/ld-linux-riscv64-lp64d.so.1"
# elif !defined(TCC_ARM_EABI)
#  if defined(TCC_MUSL)
#   if defined(TCC_TARGET_I386)
#     define CONFIG_TCC_ELFINTERP "/Library/ld-musl-i386.so.1"
#    else
#     define CONFIG_TCC_ELFINTERP "/Library/ld-musl-arm.so.1"
#    endif
#  else
#   define CONFIG_TCC_ELFINTERP "/Library/ld-linux.so.2"
#  endif
# endif
#endif
...
#define TCC_LIBGCC USE_TRIPLET(CONFIG_SYSROOT "/" CONFIG_LDDIR) "/Librarygcc_s.so.1"
#endif
