...
void        RegisterEvent(Window* pWindow, short evType, long parm1, long parm2);
void        RegisterEventInsideWndProc(Window* pWindow, short evType, long parm1, long parm2);
int         AddControlEx(Window* pWindow, int type, int anchor_mode, Rectangle rect, const char* text, int comboID, long p1, long p2);
...
void        CallControlCallback(Window * pWindow, int comboID, int event, long parm1, long parm2);
...
void        CallWindowCallbackAndControls(Window* pWindow, int eventType, long parm1, long parm2);
