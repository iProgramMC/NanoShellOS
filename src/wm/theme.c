...
},
{
	"Dark", {
		...
		.ButtonShadowColor              = 0x181818,
		.ButtonEdgeColor                = 0x808080,
		.ButtonHoverButton              = 0x404040,
		.ScrollBarSize                  = DEFAULT_SCROLL_BAR_SIZE,
		.MenuBarSelectionColor          = 0x3f3f3f,
		.SelectedItemColor              = 0x3f3f3f,
		.SelectedTextColor              = 0xffffff,
...
},
{
	"Black", {
		...
		.WindowBorderColor              = 0,
		.WindowTitleActiveColor         = 0x800080,
		.WindowTitleInactiveColor       = 0x008000,
		.WindowTitleActiveColorBright   = 0x800080,
		.WindowTitleInactiveColorBright = 0x008000,
		.WindowTitleTextColorShadow     = 0,
		.WindowTitleTextColor           = 0xffffff,
		.WindowTextColor                = 0xffffff,
		.WindowTextColorLight           = 0,
